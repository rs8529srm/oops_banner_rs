 ...
 * "OOPS"
 * using ASCII art composed of asterisks (*) and spaces. The banner is printed
 * to the
 * console using individual print statements for each line, creating a
 * decorative
 * text effect.
 *
 * <p>
 * The banner is generated by printing predefined string patterns line by line,
 * where each line contributes to forming the letters O, O, P, and S in a
 * stylized format.
